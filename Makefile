#############################################################################
# Makefile for building: DRC
# Generated by qmake (3.0) (Qt 5.7.1)
# Project:  DRC.pro
# Template: app
# Command: D:\qt-5.7.1-beagle\qtbase\bin\qmake.exe -spec devices/linux-beagleboard-g++ "CONFIG+=debug" "CONFIG+=qml_debug" -o Makefile DRC.pro
#############################################################################
...
COMPRESS      = 
DISTNAME      = DRC1.0.0
DISTDIR = D:\DRC\DRC\.tmp\DRC1.0.0
...
SOURCES       = main.cpp \
		...
		SimpleGPIO.cpp \
		modbusascii.cpp \
		tecoservotsta.cpp moc_mainwindow.cpp
OBJECTS       = main.obj \
		mainwindow.obj \
		analogjoystick.obj \
		serialport.obj \
...
Makefile: DRC.pro d:\qt-everywhere-opensource-src-5.7.1\qtbase\mkspecs\devices\linux-beagleboard-g++\qmake.conf d:\qt-everywhere-opensource-src-5.7.1\qtbase\mkspecs\features\spec_pre.prf \
	...
	$(QMAKE) -spec devices/linux-beagleboard-g++ "CONFIG+=debug" "CONFIG+=qml_debug" -o Makefile DRC.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents mainwindow.h analogjoystick.h serialport.h SimpleGPIO.h modbusascii.h tecoservotsta.h $(DISTDIR)\
	$(COPY_FILE) --parents main.cpp mainwindow.cpp analogjoystick.cpp serialport.cpp SimpleGPIO.cpp modbusascii.cpp tecoservotsta.cpp $(DISTDIR)\
...
moc_mainwindow.cpp: ..\..\qt-everywhere-opensource-src-5.7.1\qtbase\include\QtWidgets\QMainWindow \
		..\..\qt-everywhere-opensource-src-5.7.1\qtbase\include\QtWidgets\qmainwindow.h \
		..\..\qt-everywhere-opensource-src-5.7.1\qtbase\src\widgets\widgets\qmainwindow.h \
	...
	D:\qt-5.7.1-beagle\qtbase\bin\moc.exe $(DEFINES) -Id:/qt-everywhere-opensource-src-5.7.1/qtbase/mkspecs/devices/linux-beagleboard-g++ -ID:/DRC/DRC -ID:/qt-everywhere-opensource-src-5.7.1/qtbase/include -ID:/qt-everywhere-opensource-src-5.7.1/qtbase/include/QtWidgets -ID:/qt-5.7.1-beagle/qtbase/include -ID:/qt-5.7.1-beagle/qtbase/include/QtWidgets -ID:/qt-everywhere-opensource-src-5.7.1/qtbase/include/QtGui -ID:/qt-5.7.1-beagle/qtbase/include/QtGui -ID:/qt-everywhere-opensource-src-5.7.1/qtbase/include/QtCore -ID:/qt-5.7.1-beagle/qtbase/include/QtCore -Id:/gcc-linaro-6.3.1-2017.05-i686-mingw32_arm-linux-gnueabihf/arm-linux-gnueabihf/include/c++/6.3.1 -Id:/gcc-linaro-6.3.1-2017.05-i686-mingw32_arm-linux-gnueabihf/arm-linux-gnueabihf/include/c++/6.3.1/arm-linux-gnueabihf -Id:/gcc-linaro-6.3.1-2017.05-i686-mingw32_arm-linux-gnueabihf/arm-linux-gnueabihf/include/c++/6.3.1/backward -Id:/gcc-linaro-6.3.1-2017.05-i686-mingw32_arm-linux-gnueabihf/lib/gcc/arm-linux-gnueabihf/6.3.1/include -Id:/gcc-linaro-6.3.1-2017.05-i686-mingw32_arm-linux-gnueabihf/lib/gcc/arm-linux-gnueabihf/6.3.1/include-fixed -Id:/gcc-linaro-6.3.1-2017.05-i686-mingw32_arm-linux-gnueabihf/arm-linux-gnueabihf/include -ID:/BeagleBoneDebian-9-sysroot/usr/include/arm-linux-gnueabihf -ID:/BeagleBoneDebian-9-sysroot/usr/include mainwindow.h -o moc_mainwindow.cpp
...
ui_mainwindow.h: mainwindow.ui \
	...
	D:\qt-5.7.1-beagle\qtbase\bin\uic.exe mainwindow.ui -o ui_mainwindow.h
...
main.obj: main.cpp mainwindow.h \
		..\..\qt-everywhere-opensource-src-5.7.1\qtbase\include\QtWidgets\QMainWindow \
		..\..\qt-everywhere-opensource-src-5.7.1\qtbase\include\QtWidgets\qmainwindow.h \
		..\..\qt-everywhere-opensource-src-5.7.1\qtbase\src\widgets\widgets\qmainwindow.h \
		..\..\qt-everywhere-opensource-src-5.7.1\qtbase\include\QtWidgets\qwidget.h \
		..\..\qt-everywhere-opensource-src-5.7.1\qtbase\src\widgets\kernel\qwidget.h \
...
modbusascii.obj: modbusascii.cpp modbusascii.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o modbusascii.obj modbusascii.cpp

tecoservotsta.obj: tecoservotsta.cpp tecoservotsta.h \
		serialport.h \
		modbusascii.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o tecoservotsta.obj tecoservotsta.cpp
...
install_target: first FORCE
	@if not exist $(INSTALL_ROOT:@msyshack@%=%)\home\debian\DRC mkdir $(INSTALL_ROOT:@msyshack@%=%)\home\debian\DRC & if not exist $(INSTALL_ROOT:@msyshack@%=%)\home\debian\DRC exit 1
	-$(INSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT:@msyshack@%=%)\home\debian\DRC\$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT:@msyshack@%=%)\home\debian\DRC\$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT:@msyshack@%=%)\home\debian\DRC 
